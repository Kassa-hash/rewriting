...
<head>
  ...
  <meta name="author" content="<?= htmlspecialchars($article['author_name'] ?? 'La rédaction') ?> — Iran Observateur">
  ...
  <meta property="article:author" content="<?= htmlspecialchars($article['author_name'] ?? 'Iran Observateur') ?>">
  ...
  <div class="article-wrap">
    ...
    <article class="article-main">
      ...
      <div class="article-byline">
        <div class="author-avatar" aria-hidden="true"><?= strtoupper(substr($article['author_name'] ?? 'Rd', 0, 2)) ?></div>
        <div class="byline-info">
          <div class="byline-name"><?= htmlspecialchars($article['author_name'] ?? 'La rédaction') ?> — Iran Observateur</div>
      ...
      <figure class="article-img">
        <div class="article-img-fill" role="img" aria-label="Illustration article">
          <?= strtoupper(substr($article['category_slug'] ?? 'cat', 0, 3)) ?>
        </div>
        <figcaption><?= htmlspecialchars($article['category_name'] ?? 'Article') ?> — Iran Observateur</figcaption>
      </figure>
      ...
      <?php if (!empty(getArticleTags($article['id']))) { ?>
      <div class="article-tags">
        <span class="tags-label">Tags :</span>
        <?php foreach (getArticleTags($article['id']) as $tag) { ?>
