  ...
  <nav class="breadcrumb" aria-label="Fil d'Ariane">
            ...
            <?php if ($pages > 1) { ?>
                <div class="pagination">
                    <?php for ($i = 1; $i <= $pages; $i++) { ?>
                        <a href="/categorie/<?= urlencode($category['slug']) ?>/page/<?= $i ?>"
    ...
    <footer>
        <div class="footer-inner">
            ...
            <nav>
                <a href="/a-propos" style="padding: 4px 12px; text-decoration: none; color: rgba(245,240,232,0.6); font-family: 'JetBrains Mono', monospace; font-size: 10px; text-transform: uppercase;">À propos</a>
